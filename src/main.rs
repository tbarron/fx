...
fn main() {
    let mut app = App::new("fx").version(version())
        ...
        .subcommand(SubCommand::with_name("cmd")
                    .about("Replace <replstr> with arguments and run the commands")
                    ...
                    .arg(Arg::with_name("replstr")
                         ...
                         .short("r")
                         .long("replstr")
                         .help("Alternate replacement substring in command \
                                (default: '%')")
                    )
                    .arg(Arg::with_name("command")
                         .help("Command string containing <replstr>")
                         .required(true)
                    )
                    .arg(Arg::with_name("items")
                         .help("<replstr> replacements")
                         .required(true)
                         .min_values(1)
                    )
        )
        ...
        .subcommand(SubCommand::with_name("odx")
                    .about("Report hex, decimal, octal, and binary values")
                    .arg(Arg::with_name("number")
        ...
        .subcommand(SubCommand::with_name("range")
                    .about("Replace <replstr> with <interval> values and \
                            run the commands")
                    .arg(Arg::with_name("dryrun")
                         .help("Report what would happen without acting")
                         .short("n")
        ...
        .subcommand(SubCommand::with_name("xargs")
                    .about("Replace <replstr> in command with clumps of \
                            arguments")
                    .arg(Arg::with_name("dryrun")
                         .short("n")
                         .long("dryrun")
